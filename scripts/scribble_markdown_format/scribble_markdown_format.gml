function scribble_markdown_format(arg0)
{
    static _func_delete_buffer = function(arg0, arg1, arg2, arg3 = buffer_tell(arg0) - 2)
    {
        static _buffer_b = __scribble_initialize().__buffer_b;
        
        var _copy_pos = arg3 + arg2;
        var _copy_size = arg1 - _copy_pos;
        buffer_copy(arg0, _copy_pos, _copy_size, _buffer_b, 0);
        buffer_copy(_buffer_b, 0, _copy_size, arg0, arg3);
        buffer_seek(arg0, buffer_seek_relative, -1);
        return -arg2;
    };
    
    static _func_insert_buffer = function(arg0, arg1, arg2, arg3 = buffer_tell(arg0) - 2)
    {
        static _buffer_b = __scribble_initialize().__buffer_b;
        
        var _insert_size = string_byte_length(arg2);
        
        if (_insert_size <= 0)
            return 0;
        
        var _copy_size = arg1 - arg3;
        var _recopy_size = _insert_size + _copy_size;
        buffer_poke(_buffer_b, 0, buffer_text, arg2);
        buffer_copy(arg0, arg3, _copy_size, _buffer_b, _insert_size);
        buffer_copy(_buffer_b, 0, _recopy_size, arg0, arg3);
        buffer_seek(arg0, buffer_seek_relative, _insert_size - 1);
        return _insert_size;
    };
    
    static _func_delete_and_insert_buffer = function(arg0, arg1, arg2, arg3 = "", arg4 = buffer_tell(arg0) - 2)
    {
        static _buffer_b = __scribble_initialize().__buffer_b;
        
        var _copy_pos = arg4 + arg2;
        var _copy_size = arg1 - _copy_pos;
        var _insert_size = string_byte_length(arg3);
        var _recopy_size = _insert_size + _copy_size;
        buffer_poke(_buffer_b, 0, buffer_text, arg3);
        buffer_copy(arg0, _copy_pos, _copy_size, _buffer_b, _insert_size);
        buffer_copy(_buffer_b, 0, _recopy_size, arg0, arg4);
        buffer_seek(arg0, buffer_seek_relative, _insert_size - 1);
        return _insert_size - arg2;
    };
