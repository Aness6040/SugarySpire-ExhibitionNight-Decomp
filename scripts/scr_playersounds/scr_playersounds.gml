...
function scr_playersounds()
{
    ...
    if (event_instance_isplaying(sndSuplex) && saved_state != (10 << 0))
        fmod_studio_event_instance_stop(sndSuplex, true);
    
    if (saved_state == (7 << 0) && (sprite_index == spr_wallJumpIntro || sprite_index == spr_wallJump))
    {
    ...
    if (saved_state == (61 << 0) && grounded && vsp > 0 && sprite_index != spr_player_PZ_minecart_spinOut)
    {
    ...
    if ((saved_state == (16 << 0) && grounded && vsp > 0) || saved_state == (39 << 0))
    {
    ...
    if (saved_state == (58 << 0) && place_meeting(x, y, obj_cottonsolid))
    {
    ...
    if (grounded && saved_state == (41 << 0) && movespeed >= 12 && sprite_index != spr_player_PZ_dogMount_skid)
    {
    ...
    if (saved_state == (37 << 0) || saved_state == (21 << 0) || saved_state == (15 << 0))
    {
    ...
    if ((saved_state != (27 << 0) || sprite_index == spr_superjumpCancelIntro) && event_instance_isplaying(sndSuperjumpRelease))
        fmod_studio_event_instance_stop(sndSuperjumpRelease, true);
    
    if (saved_state == (32 << 0) || saved_state == (3 << 0) || saved_state == (33 << 0) || saved_state == (6 << 0))
    {
        ...
        if ((saved_state == (32 << 0) && sprite_index == spr_mach1) || (saved_state == (3 << 0) && sprite_index == spr_mach1))
            machsnd = 1;
        else if ((saved_state == (32 << 0) && sprite_index == spr_mach2) || (saved_state == (3 << 0) && movespeed < 12) || (saved_state == (6 << 0) && verticalMovespeed < 12))
            machsnd = 2;
        else if ((saved_state == (33 << 0) && sprite_index != spr_crazyrun) || saved_state == (3 << 0) || (saved_state == (6 << 0) && verticalMovespeed >= 12))
            machsnd = 3;
