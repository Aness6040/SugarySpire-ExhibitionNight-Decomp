...
if (point_in_rectangle(obj_parent_player.x, obj_parent_player.y, x - 300, y - 50, x + 300, y + 50) && obj_parent_player.state != (40 << 0) && obj_parent_player.state != (26 << 0))
{
    if ((state == (0 << 0) || state == (0 << 0)) && enemyAttackTimer <= 0)
    {
        image_index = 0;
        flash = true;
