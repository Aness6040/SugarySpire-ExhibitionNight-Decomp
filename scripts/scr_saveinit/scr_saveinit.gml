function scr_saveinit()
{
    ...
    global.HurtCounter = ini_read_real("Game", string("damage_{0}", scr_getCharacterPrefix((0 << 0))), 0);
    global.HurtMilestone = global.HurtCounter;
    global.PlayerPaletteIndex = ini_read_real("Misc", string("playerPaletteIndex_{0}", scr_getCharacterPrefix((0 << 0))), 2);
