...
function instance_place_list_collision(arg0, arg1, arg2 = (0 << 0), arg3 = undefined)
{
    var collided = 0;
    var check_slopes = !isCollisionFlagSet(arg2, (1 << 0));
    var check_solids = !isCollisionFlagSet(arg2, (2 << 0));
    var check_platforms = !isCollisionFlagSet(arg2, (8 << 0));
    var check_moving = !isCollisionFlagSet(arg2, (4 << 0));
...
function place_meeting_collision(arg0, arg1, arg2 = (0 << 0))
{
    var check_slopes = ((1 << 0) & arg2) != (1 << 0);
    var check_solids = ((2 << 0) & arg2) != (2 << 0);
    var check_platforms = ((8 << 0) & arg2) != (8 << 0);
    var check_moving = ((4 << 0) & arg2) != (4 << 0);
...
function position_meeting_collision(arg0, arg1, arg2 = (0 << 0))
{
