function scribble_add_macro(arg0, arg1)
{
    ...
    {
        __scribble_trace("Warning! Macro name \"" + arg0 + "\" has already been defined as a colour");
        exit;
    }
    
    if (ds_map_exists(_effects_map, arg0))
    {
        __scribble_trace("Warning! Macro name \"" + arg0 + "\" has already been defined as an effect");
        exit;
    }
    
    if (ds_map_exists(_typewriter_events_map, arg0))
    {
        __scribble_trace("Warning! Macro name \"" + arg0 + "\" has already been defined as a typist event");
        exit;
    }
    
    var _old_function = ds_map_find_value(_macros_map, arg0);
    ...
    ds_map_set(_macros_map, arg0, arg1);
}
