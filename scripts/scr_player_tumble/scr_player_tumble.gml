function state_player_tumble()
{
    ...
    if (place_meeting_collision(x + xscale, y, (1 << 0)) && !place_meeting(x + xscale, y, obj_destructibles) && !place_meeting(x + xscale, y, obj_chocofrog_tumble))
    {
    ...
    with (create_afterimage((0 << 0), xscale))
    {
        gonealpha = 0.85;
        alarm[0] = 1;
        alarm[1] = 60;
