function draw_text_scribble(arg0, arg1, arg2, arg3 = undefined)
{
    ...
    var _element = scribble(arg2, "__draw_text_scribble__").align(draw_get_halign(), draw_get_valign()).starting_format(_font, 16777215).blend(draw_get_color(), draw_get_alpha());
