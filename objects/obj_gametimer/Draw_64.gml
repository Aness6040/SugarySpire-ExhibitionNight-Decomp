if (!global.option_timer_type || room == rm_disclaimer || room == rm_initializer || room == rm_introVideo || room == rm_preinitializer || room == rm_startupLogo || room == rm_mainmenu || (!global.option_speedrun_timer && (instance_exists(obj_inputController) && (obj_inputController.showtext || obj_inputController.disconnectScreen))))
    exit;
